        ...
        while (true) {
            ...
            for (int i = 0; i < item.length; i++) {
                if (item[i].isCreateNew()) {
                    ...
                    switch (r.nextInt(2)) {
                        case 0:
                            item[i] = new gravUp(getWidth() + r.nextInt(500) * 10);
                            break;
                        case 4:
                            item[i] = new gravDown(getWidth() + r.nextInt(500) * 10);
                            break;
                        case 2:
                            item[i] = new AgilUp(getWidth() + r.nextInt(500) * 10);
                            break;
                        case 3:
                            item[i] = new AgilDown(getWidth() + r.nextInt(500) * 10);
                            break;
                        case 1:
                            item[i] = new Score(getWidth() + r.nextInt(500) * 10, this);
                            break;
